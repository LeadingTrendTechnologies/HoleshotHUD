...
pub fn abi_text() -> String {
    ...
    field(
        ...
        "MxboShmRider",
        "name",
        offset_of!(Rider, name),
        NAME,
    );
    field(&mut o, "MxboShmRider", "lean", offset_of!(Rider, lean), 4);
    field(&mut o, "MxboShmRider", "y", offset_of!(Rider, y), 4);
    field(&mut o, "MxboShmRider", "speed", offset_of!(Rider, speed), 4);
    field(&mut o, "MxboShmRider", "rpm", offset_of!(Rider, rpm), 4);
    field(&mut o, "MxboShmRider", "gear", offset_of!(Rider, gear), 4);
    field(
        &mut o,
        "MxboShmRider",
        "throttle",
        offset_of!(Rider, throttle),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmStanding",
        "bestLapMs",
        offset_of!(Standing, best_lap_ms),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmStanding",
        "lastLapMs",
        offset_of!(Standing, last_lap_ms),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "localRaceNum",
        offset_of!(Snapshot, local_race_num),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "focusRaceNum",
        offset_of!(Snapshot, focus_race_num),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "hasTelemetry",
        offset_of!(Snapshot, has_telemetry),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localCrashed",
        offset_of!(Snapshot, local_crashed),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "localVelX",
        offset_of!(Snapshot, local_vel_x),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localVelZ",
        offset_of!(Snapshot, local_vel_z),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "localSpeed",
        offset_of!(Snapshot, local_speed),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localTrackPos",
        offset_of!(Snapshot, local_track_pos),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "trackLength",
        offset_of!(Snapshot, track_length),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "poly",
        offset_of!(Snapshot, poly),
        size_of::<[Point; MAX_POLY]>(),
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "riderCount",
        offset_of!(Snapshot, rider_count),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "riders",
        offset_of!(Snapshot, riders),
        size_of::<[Rider; MAX_RIDERS]>(),
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "standingCount",
        offset_of!(Snapshot, standing_count),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "standingsRect",
        offset_of!(Snapshot, standings_rect),
        size_of::<Rect>(),
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "showStandings",
        offset_of!(Snapshot, show_standings),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "showRelative",
        offset_of!(Snapshot, show_relative),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "standingsRows",
        offset_of!(Snapshot, standings_rows),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "relativeCount",
        offset_of!(Snapshot, relative_count),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "engineTemp",
        offset_of!(Snapshot, engine_temp),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "lastLapMs",
        offset_of!(Snapshot, last_lap_ms),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "currentLapMs",
        offset_of!(Snapshot, current_lap_ms),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "currentLap",
        offset_of!(Snapshot, current_lap),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sessionLaps",
        offset_of!(Snapshot, session_laps),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "sessionTimeMs",
        offset_of!(Snapshot, session_time_ms),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sessionLength",
        offset_of!(Snapshot, session_length),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "bestLapMs",
        offset_of!(Snapshot, best_lap_ms),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sectorCount",
        offset_of!(Snapshot, sector_count),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sectorLast",
        offset_of!(Snapshot, sector_last),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "sectorBest",
        offset_of!(Snapshot, sector_best),
        size_of::<[i32; MAX_SECTORS]>(),
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sectorDelta",
        offset_of!(Snapshot, sector_delta),
        size_of::<[i32; MAX_SECTORS]>(),
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sectorDeltaValid",
        offset_of!(Snapshot, sector_delta_valid),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sessionKind",
        offset_of!(Snapshot, session_kind),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "sessionState",
        offset_of!(Snapshot, session_state),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "localPitch",
        offset_of!(Snapshot, local_pitch),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localSteer",
        offset_of!(Snapshot, local_steer),
        4,
    );
    field(
        &mut o,
    ...
    field(
        ...
        "MxboShmSnapshot",
        "localThrottle",
        offset_of!(Snapshot, local_throttle),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localFrontBrake",
        offset_of!(Snapshot, local_front_brake),
        4,
    );
    field(
        &mut o,
        "MxboShmSnapshot",
        "localRearBrake",
        offset_of!(Snapshot, local_rear_brake),
        4,
    );
    field(
        &mut o,
