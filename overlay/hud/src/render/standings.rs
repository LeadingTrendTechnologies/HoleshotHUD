                        ...
                        row.paint(
                            ...
                            |kind| match kind {
                                ...
                                StField::Laps => (
                                    format!(
                                        "{}",
                                        standing_num_laps(s, standing.race_num, standing.num_laps)
                                    ),
                                    dim,
                                    true,
                                ),
                                ...
                                StField::Best => (
                                    ...
                                    if best_ms > 0 && standing.best_lap_ms == best_ms && !out {
                                        purple
                                    } else {
                                        dim
                                    },
