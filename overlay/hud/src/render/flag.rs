...
pub(crate) fn draw_flag(
    ...
    draw_flag_caption_fade(
        px,
        band.as_ref().unwrap_or(&path),
        cx,
        y,
        inner_w,
        white_w,
...
pub(crate) fn flag_caption_band_path(
    x: f32,
    y: f32,
    inner_w: f32,
    h: f32,
