...
export class Preview {
     ...
     */
    frame(width, height) {
        const ret = wasm.preview_frame(this.__wbg_ptr, width, height);
     ...
     */
    tick(dt) {
        wasm.preview_tick(this.__wbg_ptr, dt);
    }
    /**
     * @param {string} name
     * @returns {boolean}
    ...
    widget_on(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.preview_widget_on(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./mxbo_web_preview_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mxbo_web_preview_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
