...
- Primary color: Settings → Look → **Primary color** (default Holeshot orange `#FF9430`). One `[App] primary_color=` key. You-dots, Dash P#, plaques, controller presses, and Motos chrome follow it. Lapping blue / lapped red / flags stay semantic.
...
- Minimap / radar / dash / ticker / sys / stance / flag / delta / sector / lean / telemetry / gamepad read `cfg.show_*` directly (`cfg.gamepad_visible()` is show-only).
