...
**Break logic?** **Critical** if you change `Snapshot` field order, `MAGIC`, `VERSION`, or `Local\MXBOHudV15`. The adapter must not invent fields the plugin did not publish.
