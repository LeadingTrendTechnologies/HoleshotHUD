...
`live_order_active`: needs `on_track` (a run, or positions / telemetry — so replay counts; leftover garage standings do not), a real `track_length`, two or more riders, not
